...
#include "Game.h"
SDLGameObject::SDLGameObject(const LoaderParams* pParams):GameObject(pParams),m_position(Vector2D(pParams->getX(),pParams->getY())),m_velocity(0,0),m_acceleration(0,0){
